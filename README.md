...
4. Send 10000 WEND to this address and wait for at least 1 confirmation
...
```
bash <( curl -sL https://raw.githubusercontent.com/wellnode/masternodescript/main/install.sh)
```
...
```<alias> <ip>:50312 <private_key> <tx_id> <index>```
3. It should look something like this:
``` MN1 127.0.0.2:50312 XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX X```
...
3. Enter ```wend-cli getmasternodestatus```
4. This will tell you the status of your masternode, any questions, Join discord for help: https://discord.gg/T8924XMGrZ
